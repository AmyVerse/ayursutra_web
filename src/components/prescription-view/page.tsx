...
function PrescriptionViewContent() {
              ...
              <div className="bg-blue-50 p-6 rounded-xl border border-blue-200 print:bg-gray-50">
                ...
                <div className="space-y-6">
                  {therapyProgress.map((therapy, index) => (
                    <div
                      key={index}
                      className="bg-white rounded-xl border border-blue-200 overflow-hidden print:break-inside-avoid"
                    >
                            ...
                            <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200 print:bg-gray-50">
                              <div className="flex justify-between items-center mb-3">
                                <h4 className="font-semibold text-yellow-800 print:text-gray-800 flex items-center">
                                  <span className="w-6 h-6 bg-yellow-500 text-white rounded-full flex items-center justify-center text-xs font-bold mr-2 print:bg-gray-500">
                                    P
                                  </span>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                                {therapy.purvakarma.map((item, i) => {
                                  const { completedDays, assignedDays } =
                                    getKarmaDaysProgress(therapy, "purvakarma");
                                  ...
                                  const currentItem = Math.min(
                                    completedItems,
                                    therapy.purvakarma.length - 1
                                  );

                                  return (
                                    <div
                                      key={i}
                                      className={`flex items-center p-2 rounded border border-yellow-200 transition-all duration-300 ${
                                        i < completedItems
                            ...
                            <div className="bg-red-50 p-4 rounded-lg border border-red-200 print:bg-gray-50">
                              <div className="flex justify-between items-center mb-3">
                                <h4 className="font-semibold text-red-800 print:text-gray-800 flex items-center">
                                  <span className="w-6 h-6 bg-red-500 text-white rounded-full flex items-center justify-center text-xs font-bold mr-2 print:bg-gray-500">
                                    M
                                  </span>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                                {therapy.pradhanakarma.map((item, i) => {
                                  ...
                                  const itemsPerDay = Math.ceil(
                                    therapy.pradhanakarma.length / assignedDays
                                  );
                                  const completedItems = Math.min(
                                    completedDays * itemsPerDay,
                                  ...
                                  const currentItem = Math.min(
                                    completedItems,
                                    therapy.pradhanakarma.length - 1
                                  );

                                  return (
                                    <div
                                      key={i}
                                      className={`flex items-center p-2 rounded border border-red-200 transition-all duration-300 ${
                                        i < completedItems
                                          ? "bg-green-100 border-green-300"
                                          : i === currentItem &&
                                              completedDays < assignedDays
                            ...
                            <div className="bg-green-50 p-4 rounded-lg border border-green-200 print:bg-gray-50">
                              <div className="flex justify-between items-center mb-3">
                                <h4 className="font-semibold text-green-800 print:text-gray-800 flex items-center">
                                  <span className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center text-xs font-bold mr-2 print:bg-gray-500">
                                    A
                                  </span>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                                {therapy.paschatkarma.map((item, i) => {
                                  ...
                                  const currentItem = Math.min(
                                    completedItems,
                                    therapy.paschatkarma.length - 1
                                  );

                                  return (
                                    <div
                                      key={i}
                                      className={`flex items-center p-2 rounded border border-green-200 transition-all duration-300 ${
                                        i < completedItems
                                          ? "bg-green-100 border-green-300"
                                          : i === currentItem &&
                                              completedDays < assignedDays
                            ...
                            <div className="mt-3 bg-white p-3 rounded border border-blue-200">
                              <div className="flex items-center justify-between">
                                ...
                                <div className="text-right">
                                  <p className="text-sm text-gray-800 font-medium">
                                    {therapy.totalDays || 7} days total
                                  </p>
                                  <p className="text-xs text-gray-500">
                                    {getCompletedDays(therapy)} days completed,{" "}
                                    {getRemainingDays(therapy)} remaining
                                  </p>
                                  <p className="text-xs text-blue-600 mt-1">
                                    Karma breakdown:{" "}
                                    {therapy.purvakarmaDays || 2} +{" "}
                                    {therapy.pradhanakarmaaDays || 4} +{" "}
                                    {therapy.paschatkarmaaDays || 1} ={" "}
                                    {getTotalKarmaDays(therapy)} days
                                  </p>
                ...
                <div className="bg-white p-4 rounded-lg border border-purple-200">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {prescriptionData.medications.map((medication, index) => (
                      <div
                        key={index}
                        className="flex items-center p-3 bg-purple-50 rounded-lg print:bg-gray-50"
                      >
